updated-highcharts-ng
=============

AngularJS directive for Highcharts updated with resize event.
...
```bower install updated-highcharts-ng```
...
To resize it in AngularJS on action, invoke $rootScope.$broadcast('window.resizeCharts');
